...
#    Updated: 2018/04/08 15:22:40 by male-gal         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC= ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c  \
	 ft_isdigit.c ft_ismaj.c ft_ismin.c ft_ismyspace.c ft_isprint.c ft_itoa.c \
	 ...
	 ft_memcpy.c ft_memdel.c ft_memmove.c ft_memset.c ft_print_words_tables.c \
	 ft_putchar.c ft_putchar_fd.c ft_putendl.c ft_putendl_fd.c ft_putnbr.c \
	 ft_putnbr_fd.c ft_putstr.c ft_putstr_fd.c ft_readmem.c ft_strcat.c \
